...
import medicine.health.lab.test.medical.online.fitness.map.viewmodel.pregnancyViewModel
...
import medicine.health.lab.test.medical.online.fitness.food.shopping.pregnancy.view.adapter.CategoryStoresAdapter
   ...
   override val layoutId: Int
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (firebaseRemoteConfig == null) {
            ...
            pregnancyViewModel = ViewModelProvider(requireActivity()).get(medicine.health.lab.test.medical.online.fitness.map.viewmodel.pregnancyViewModel::class.java)
