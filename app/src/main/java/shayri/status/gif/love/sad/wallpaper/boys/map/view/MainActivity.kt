...
import shayri.status.gif.love.sad.wallpaper.boys.girls.attitude.all.utils.CustomViewPager
import shayri.status.gif.love.sad.wallpaper.boys.girls.attitude.all.utils.ForceUpdateChecker
import shayri.status.gif.love.sad.wallpaper.boys.girls.attitude.all.utils.Pref
import shayri.status.gif.love.sad.wallpaper.boys.girls.attitude.all.view.adapter.home.AllAppsAdapter
...
import shayri.status.gif.love.sad.wallpaper.boys.girls.attitude.all.viewmodel.DealsViewModel
import shayri.status.gif.love.sad.wallpaper.boys.girls.attitude.all.viewmodel.HomeViewModel
import shayri.status.gif.love.sad.wallpaper.boys.girls.attitude.all.viewpager.AppPagerAdapter
import java.util.*
...
// Set on click listener
    ...
    fun onShowIntro() {
        ...
        fancyHome = FancyShowCaseView.Builder(this@MainActivity)
            ...
            .typeface(typeface)
            .showOnce("FANCY_HOME")
            .title("Latest Poems Stacked in one Place")
            .build()
        fancyCategories = FancyShowCaseView.Builder(this@MainActivity)
            ...
            .title("Shayri Categories and HD WallPapers")
            .build()
        ...
        fancyBookmarks = FancyShowCaseView.Builder(this@MainActivity)
            ...
            .title("Search For Your Fav Gif & Share")
            .build()
